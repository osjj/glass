...
import { ArticleContentRenderer } from "@/components/site/article-content-renderer";
...
export default async function BlogPostPage({ params }: BlogPostPageProps) {
  ...
  return (
    <article>
      ...
      <div className="site-container"><div className="relative mx-auto aspect-[16/8] max-w-5xl overflow-hidden rounded-2xl bg-[var(--navy)]"><Image src={article.coverImage} alt={article.coverImageAlt} fill priority unoptimized sizes="(min-width: 1024px) 1000px, 100vw" className="object-cover" /></div></div>
